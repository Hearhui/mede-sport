      ...
      {isA4 ? (
            ...
            <div className="flex justify-between items-start border-b-2 border-blue-600 pb-4 mb-6">
              <div>
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div>
                    <h1 className="text-lg font-bold text-gray-900">{company?.name || "บริษัท มีดี สปอร์ต จำกัด (สำนักงานใหญ่)"}</h1>
                    <p className="text-xs text-gray-500">{company?.nameEn || "MEDE SPORT CO.,LTD (Head Office)"}</p>
                  </div>
                </div>
                <div className="text-xs text-gray-600 space-y-0.5">
                  ...
                  <p>โทร. {company?.phone || "087-0356821"}</p>
                  <p>เลขประจำตัวผู้เสียภาษี {company?.taxId || "0105563110337"}</p>
                </div>
              </div>
        ...
        <div className="max-w-[80mm] mx-auto bg-white p-4 text-xs font-mono print:p-2 print:shadow-none shadow-lg" style={{ minHeight: "auto" }}>
          <div className="text-center border-b border-dashed border-gray-400 pb-3 mb-3">
            ...
            <p className="text-[10px] text-gray-500 mt-1">{company?.address1 || "339/303 ซอยเพชรเกษม 69 แยก 5"}</p>
